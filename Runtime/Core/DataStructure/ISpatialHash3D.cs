...
namespace WallstopStudios.UnityHelpers.Core.DataStructure
{
    ...
    /// an inverted or NaN box all return the cleared, empty destination list.</para>
    ...
    public interface ISpatialHash3D<T> : IDisposable
    {
        ...
        bool TryInsert(Vector3 position, T item);
        ...
        /// <summary>
        /// Collects every item inside the specified box, faces included.
        /// </summary>
