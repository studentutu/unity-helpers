...
- For documentation-only changes (use [update-documentation](../skills/update-documentation.md) directly)
...
1. Fix the issue (see [validate-before-commit](../skills/validate-before-commit.md#rule-4-spell-check-every-change-cspell-covers) for the spelling decision tree)
...
Execute a [review-code-changes](../skills/review-code-changes.md) pass on all staged/modified files:

1. Run two-pass review (Critical, then Informational)
2. Auto-fix mechanical issues (formatting, spelling, missing null checks)
3. Track risk score per [self-regulate-changes](../skills/self-regulate-changes.md)
...
4. **Keep entries SHORT — one or two sentences, plain language, user-visible effect first.** No
   ...
   [update-documentation](../skills/update-documentation.md#writing-good-changelog-entries).

### Step 5: Documentation Check

Per [update-documentation](../skills/update-documentation.md):
