...
- [unity-mcp-fixture-runner](./unity-mcp-fixture-runner.md) — reaching package types by reflection,
  running fixtures, and what the loop must replicate or a passing test reports as failed.
- [unity-mcp-measurement](./unity-mcp-measurement.md) — timing, why allocation is not measurable
